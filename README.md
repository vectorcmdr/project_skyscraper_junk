...
- Root files are scripts, general reports and base images for analysis.
...
### Things of note:
- `IMG_00004.jpg` & `TR4CE.jpg` could use some help with possible DQT crypto keys for `project-skyscraper.jpg`, there are other file anomalies too. Read the reports.
